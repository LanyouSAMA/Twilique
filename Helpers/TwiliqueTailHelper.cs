...
namespace Twilique
{
    public static class TwiliqueTailHelper
    {
        /// <summary>
        /// 弹幕拖尾(弹幕，拖尾贴图，拖尾偏移，拖尾颜色1，拖尾颜色2，拖尾宽度，是否采用拖尾逐渐缩小，是否采用A值归零)
        /// </summary>
        public static void ProjectileDrawTail(Projectile Projectile, Texture2D Tail, Vector2 DrawOrigin, Color TailColor1, Color TailColor2, float Width, bool Lerp, bool A = false)
        {
